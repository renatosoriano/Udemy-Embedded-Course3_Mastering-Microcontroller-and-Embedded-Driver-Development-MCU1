/*
 * 009_SPI_TxRx_Arduino_Interrupt.c
 *
...
void Slave_GPIO_InterruptPinInit(void)
{
	...
	spiIntPin.pGPIOx = GPIOC;	/* For NUCLEO-F446RE */
	spiIntPin.GPIO_PinConfig.GPIO_PinNumber = GPIO_PIN_NO_6;	/* For NUCLEO-F446RE */
	...
	*/
	...
	while(1){
		...
		while(!rcvStop)
		{
			...
			while ( SPI_SendDataInterruptMode(&SPI2handle,&dummy,1) == SPI_BUSY_IN_TX);
